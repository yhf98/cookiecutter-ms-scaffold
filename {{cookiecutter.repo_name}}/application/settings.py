...
EVENTS = [
    ...
    # "core.event.connect_rabbitmq" if RABBIT_ENABLE else None,
]
TRACER_EVENTS = [
    "core.event.connect_redis" if REDIS_DB_ENABLE else None,
    "core.event.connect_mongo" if MONGO_DB_ENABLE else None,
...
CONSUMER_EVENTS = [
    ...
    "core.event.connect_mongo" if MONGO_DB_ENABLE else None,
    "core.event.connect_rabbitmq" if RABBIT_ENABLE else None,
    "core.event.setup_rabbitmq_consumer" if RABBIT_ENABLE else None,
]
...
"""
MIDDLEWARES = [
    # "core.middleware.register_base_auth_middleware",
