...
async def get_banners(auth: Auth = Depends(AllUserAuth())):
    data = [
        {
            "id": 1, "image": "https://ktianc.oss-cn-beijing.aliyuncs.com/ms-api/system/banner/2022-11-14/1.jpg"
        },
        {
            "id": 2, "image": "https://ktianc.oss-cn-beijing.aliyuncs.com/ms-api/system/banner/2022-11-09/banner1.png"
        },
        {
            "id": 3, "image": "https://ktianc.oss-cn-beijing.aliyuncs.com/ms-api/system/banner/2022-11-09/banner3.png"
        },
    ]
