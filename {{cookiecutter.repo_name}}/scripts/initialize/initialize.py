...
class InitializeData:
    ...
    #     生成部门详情数据
    #     """
    #     await self.__generate_data("admin_auth_dept", auth_models.AdminDept)

    # async def generate_user_dept(self):
    #     """
    #     生成用户关联部门详情数据
    #     """
    #     await self.__generate_data("admin_auth_user_depts", auth_models.admin_auth_user_depts)

    # async def generate_menu(self):
    #     """
    #     生成菜单数据
    #     """
    #     await self.__generate_data("admin_auth_menu", auth_models.AdminMenu)

    # async def generate_role(self):
    #     """
    #     生成角色
    #     """
    #     await self.__generate_data("admin_auth_role", auth_models.AdminRole)

    # async def generate_user(self):
    #     """
    #     生成用户
    #     """
    #     await self.__generate_data("admin_auth_user", auth_models.AdminUser)

    # async def generate_user_role(self):
    #     """
    #     生成用户
    #     """
    #     await self.__generate_data("admin_auth_user_roles", auth_models.admin_auth_user_roles)

    # async def generate_system_tab(self):
    #     """
    #     生成系统配置分类数据
    #     """
    #     await self.__generate_data("admin_system_settings_tab", system_models.AdminSystemSettingsTab)

    # async def generate_system_config(self):
    #     """
    #     生成系统配置数据
    #     """
    #     await self.__generate_data("admin_system_settings", system_models.AdminSystemSettings)

    # async def generate_dict_type(self):
    #     """
    #     生成字典类型数据
    #     """
    #     await self.__generate_data("admin_system_dict_type", system_models.AdminDictType)

    # async def generate_dict_details(self):
    #     """
    #     生成字典详情数据
    #     """
    #     await self.__generate_data("admin_system_dict_details", system_models.AdminDictDetails)

    # async def generate_help_issue_category(self):
    #     """
    #     生成常见问题类别数据
    #     """
    #     await self.__generate_data("admin_help_issue_category", help_models.AdminIssueCategory)

    # async def generate_help_issue(self):
    #     """
    #     生成常见问题详情数据
    #     """
    #     await self.__generate_data("admin_help_issue", help_models.AdminIssue)
